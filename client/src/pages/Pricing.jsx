...
const basePlans = [
  ...
  { name: 'Plus', price: 11, annualPrice: 8.80, desc: 'For growing teams.', features: ['Everything in Starter', 'Up to 6 staff', 'Unlimited appointments', 'Staff roster & schedule', 'Loyalty points (50 cards)', 'Reviews & Gallery'], cta: 'Try free for 3 months', popular: true, trial: '3 months free trial' },
  { name: 'Growth', price: 29, annualPrice: 23.20, desc: 'For established businesses.', features: ['Everything in Plus', 'Unlimited staff', 'Advanced reports', 'Unlimited loyalty system', 'Unlimited email automation', 'Priority marketplace ranking', 'Promotions & deals engine'], cta: 'Try free for 60 days', popular: false, trial: '60 days free trial' },
]
