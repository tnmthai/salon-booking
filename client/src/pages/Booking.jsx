    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-20 text-center">
        ...
        <div className="bg-white rounded-xl shadow p-6 text-left">
          ...
          <div className="mb-2"><strong>Time:</strong> {selected.slot && new Date(selected.slot.start).toLocaleTimeString('en-NZ', { timeZone: 'Pacific/Auckland', hour: '2-digit', minute: '2-digit' })}</div>
              ...
              <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
                {slots.map((slot, i) => (
                  <button key={i} onClick={() => setSelected({...selected, slot})}
                    ...
                    <div className="font-medium">{new Date(slot.start).toLocaleTimeString('en-NZ', { timeZone: 'Pacific/Auckland', hour: '2-digit', minute: '2-digit' })}</div>
                  </button>
                ))}
              </div>
            )}
          ...
          <div>
            ...
            <div className="bg-pink-50 rounded-xl p-6 mb-6">
              ...
              <div className="space-y-1 text-sm">
                ...
                <div><strong>Time:</strong> {selected.slot && new Date(selected.slot.start).toLocaleTimeString('en-NZ', { timeZone: 'Pacific/Auckland', hour: '2-digit', minute: '2-digit' })}</div>
